...
let pageNames = ["회사소개","서비스", "오시는길", "연락처"]
...
let ServiceList = [
    ...
    },
    {
        ...
        "content": <p>다양한 사업분야를 경험한 전문가 집단으로 우리의 일이 고객사와 근로자에게 더 나은 내일을 가져다 줄 것이라고 확신합니다. 내일을 아름다운 내일을 만드는 것은 끊임없는 노력이 있어야만 가능합니다.<br/> 빠르게 변화하는 글로벌 시장 속에서 뒤처지지 않기 위해 늘 먼저 움직이려 합니다. 정확한 분석과 타당한 근거를 바탕으로 여러분에게 새로운 길을 제시하겠습니다</p>,
        "img": dispatch2
    },
    {
        "title":"인력 확보 방안 1",
